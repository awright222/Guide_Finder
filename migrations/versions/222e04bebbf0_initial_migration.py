...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('reviews', schema='guide_finder_schema')
    op.drop_table('messages', schema='guide_finder_schema')
    op.drop_table('favorites', schema='guide_finder_schema')
    op.drop_table('bookings', schema='guide_finder_schema')
    op.drop_table('services', schema='guide_finder_schema')
    op.drop_table('users', schema='guide_finder_schema')
    op.execute("DROP SCHEMA IF EXISTS guide_finder_schema CASCADE")
    # ### end Alembic commands ###