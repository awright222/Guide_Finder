...
class Service(db.Model):
    ...
    guide_id = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=False)  # Update foreign key
    ...
    guide = db.relationship('User', back_populates='services')  # Update relationship
